 ...
 * @date 2022/5/6 21:25
 */
public class TopicExchangeConsumer02 {
    /**
     * 队列名称
     */
     ...
     * routing key
     */
    public static final String ROUTING_KEY_01 = "*.*.rabbit";
    public static final String ROUTING_KEY_02 = "lazy.#";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 当有多个主题时需要进行多重绑定
            channel.queueBind(QUEUE_NAME, TOPIC_EXCHANGE_NAME, ROUTING_KEY_01);
            channel.queueBind(QUEUE_NAME, TOPIC_EXCHANGE_NAME, ROUTING_KEY_02);

            final String className = TopicExchangeConsumer02.class.getSimpleName();
